...
void run_database_tests(){
  ...
  w_point = 0;
  tests_assert_equal(base + w_point, test_object_123_1, "uid-123/1 written to correct place");

  // ----- Sector 0 Object 2
  database_put(db, "uid-abc", 1, (uint8_t*)test_object_abc_1, test_object_len);
  w_point = TEST_SECTOR_SIZE * 0 + test_object_len_aligned;
  tests_assert_equal(base + w_point, test_object_abc_1, "uid-abc/1 written to correct place");

  // ----- Sector 1 Object 1
  database_put(db, "uid-456", 1, (uint8_t*)test_object_456_1, test_object_len);
  w_point = TEST_SECTOR_SIZE;
  tests_assert_equal(base + w_point, test_object_456_1, "uid-456/1 written to correct place");

  // ----- Sector 1 Object 2
  database_put(db, "uid-def", 1, (uint8_t*)test_object_def_1, test_object_len);
  w_point = TEST_SECTOR_SIZE * 1 + test_object_len_aligned;
  tests_assert_equal(base + w_point, test_object_def_1, "uid-def/1 written to correct place");

  // ----- Sector 2 Object 1
  database_put(db, "uid-abc", 2, (uint8_t*)test_object_abc_2, test_object_len);
  w_point = TEST_SECTOR_SIZE * 2;
  tests_assert_equal(base + w_point, test_object_abc_2, "uid-abc/2 written to correct place");

  // ----- Sector 2 Object 2
  database_put(db, "uid-def", 2, (uint8_t*)test_object_def_2, test_object_len);
  w_point = TEST_SECTOR_SIZE * 2 + test_object_len_aligned;
  tests_assert_equal(base + w_point, test_object_def_2, "uid-def/2 written to correct place");

  // ----- Sector 3 Object 1
  database_put(db, "uid-abc", 3, (uint8_t*)test_object_abc_3, test_object_len);
  w_point = TEST_SECTOR_SIZE * 3;
  tests_assert_equal(base + w_point, test_object_123_1, "uid-123 safe from erase");
  w_point = TEST_SECTOR_SIZE * 3 + test_object_len_aligned;
  tests_assert_equal(base + w_point, test_object_abc_3, "uid-abc/3 written to correct place");

  // ----- Sector 0 Object 1
  database_put(db, "uid-def", 3, (uint8_t*)test_object_def_3, test_object_len);
  w_point = 0;
  tests_assert_equal(base + w_point, test_object_456_1, "uid-456 safe from erase");
  w_point = TEST_SECTOR_SIZE * 0 + test_object_len_aligned;
  tests_assert_equal(base + w_point, test_object_def_3, "uid-def/3 written to correct place");

  // ----- Sector 1 Object 1
  database_put(db, "uid-abc", 4, (uint8_t*)test_object_abc_4, test_object_len);
  w_point = TEST_SECTOR_SIZE;
  tests_assert_equal(base + w_point, test_object_abc_4, "uid-abc/4 written to correct place");
  ...
  w_point = TEST_SECTOR_SIZE * 1 + test_object_len_aligned;
  tests_assert_equal(base + w_point, test_object_def_4, "uid-def/4 written to correct place");
  ...
  tests_assert_equal(base + w_point, test_object_123_1, "uid-123 safe from erase");
  w_point = TEST_SECTOR_SIZE * 2 + test_object_len_aligned;
  tests_assert_equal(base + w_point, test_object_abc_5, "uid-abc/5 written to correct place");
  ...
  tests_assert_equal(base + w_point, test_object_456_1, "uid-456 safe from erase");
  w_point = TEST_SECTOR_SIZE * 3 + test_object_len_aligned;
  tests_assert_equal(base + w_point, test_object_def_5, "uid-def/5 written to correct place");
  ...
  tests_assert_equal(b, "UID: uid-123 Ver: 1 is: x", "can get uid-123");
  tests_assert_equal_num(s, test_object_len_aligned, "length correct");

  s=database_get(db, "uid-456", 0, (uint8_t*)b, 128);
  tests_assert_equal(b, "UID: uid-456 Ver: 1 is: x", "can get uid-456");
  tests_assert_equal_num(s, test_object_len_aligned, "length correct");

  s=database_get(db, "uid-abc", 0, (uint8_t*)b, 128);
  tests_assert_equal(b, "UID: uid-abc Ver: 5 is: x", "can get uid-abc");
  tests_assert_equal_num(s, test_object_len_aligned, "length correct");

  s=database_get(db, "uid-def", 0, (uint8_t*)b, 128);
  tests_assert_equal(b, "UID: uid-def Ver: 5 is: x", "can get uid-def");
  tests_assert_equal_num(s, test_object_len_aligned, "length correct");
