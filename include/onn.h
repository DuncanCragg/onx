...
#include <onx/items.h> // only for list
...
typedef bool (*onn_evaluator)(struct object* n, void* data);
...
/** create a new local Object.
    ...
    evaluator: name of callback function, set in onn_set_evaluators(), to get and set values on this Object
...
/** true if it's a local Object (hosted/animated in this ONX). */
...
extern object* onn_device_object;
...
void onn_set_evaluators(char* name, ... /* onn_evaluator evaluator, ..., 0 */); // REVISIT: do array trick

/** call this to give CPU to ONN.
